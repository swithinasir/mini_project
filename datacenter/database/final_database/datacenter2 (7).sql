...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 11, 2019 at 10:14 AM
...
--
-- Dumping data for table `bit_bos`
--

INSERT INTO `bit_bos` (`id`, `n_bos`, `ayear`, `date`, `pic`) VALUES
(1, 20, '2018-2019', '2018-10-29', '2304-bos.jpg'),
(2, 18, '2017-2018', '2017-11-04', '58859-18-bos-photo.jpg');
...
--
-- Dumping data for table `bit_bos_mem`
--

INSERT INTO `bit_bos_mem` (`id`, `bid`, `name`, `desig`, `adde`, `cate`) VALUES
(1, 1, 'Dr. D.Thilagavathy', 'Professor', 'Adhiyamaan College of Engineering', 'Chairman'),
(2, 1, 'Dr. K.Kulothungan', 'Assistant Professor (Sr.Gr)', 'Department of Information Science and Technology -	CEG Campus \r\nAnna University -Chennai\r\n', 'University Nominee'),
(3, 1, 'Dr.S.Neelavathy Pari', 'Assistant Professor', 'Department of Computer Technology\r\nMIT Campus-Chennai\r\n', 'Academic Council Nominee'),
(4, 1, 'Dr.R.Manikandan', 'Assistant Professor', 'Department of Computer Science and Engineering\r\nGovernment College of Engineering-Dharmapuri\r\n', 'Academic Council Nominee'),
(5, 1, 'Mr.K.C Rohit', 'Project Lead', 'Tata Consultancy Services - Bangalore', 'Industry Expert'),
(6, 1, 'Mr.Krishnamoorthy', 'Technical Team Lead', 'Hewlett Packard-Bangalore', 'Alumni'),
(7, 1, 'Dr.G.Fathima', 'Professor ', 'Department of Computer Science and Engineering\r\nAdhiyamaan College of Engineering\r\n', 'Interdisciplinary member'),
(8, 1, 'Dr.D.Geetha', 'Assistant Professor', 'Dept. of Computer Science and Engineering,\r\nAdhiyamaan College of Engineering\r\n', 'Interdisciplinary member'),
(9, 1, 'Dr.S.Sumathi', 'Proessor & Head', 'Dept. of Electronics and Communication Enginering,\r\nAdhiyamaan College of Engineering,\r\n', 'Interdisciplinary member'),
(10, 1, 'V.Siva Kumar', 'Assistant Professor', 'ADept. of Information Technology\r\nAdhiyamaan College of Engineering\r\n', 'Senior Faculty of the Department'),
(11, 1, 'S.Sivanandham ', 'Assistant Professor', 'Dept. of Information Technology\r\nAdhiyamaan College of Engineering\r\n', 'Senior Faculty of the Department'),
(12, 1, 'R.Regin', 'Assistant Professor', 'Dept. of Information Technology\r\nAdhiyamaan College of Engineering\r\n', 'Senior Faculty of the Department'),
(13, 2, 'Dr.G.Fathima', 'Professor', 'Adhiyamaan College of Engineering', 'Chairman'),
(14, 2, 'Dr.T.Revathi', 'Professor and Head ', 'Department of IT,Mepco Schlenk College of Engg.,\r\nSivakasi â€“', 'University Nominee'),
(15, 2, 'Dr.A.M Kalpana', 'Assistant Professor', 'HOD/CSE,\r\nGovernment College of Engineering', 'Academic Council Nominee'),
(16, 2, 'Dr.G.Varaprasad', 'Associate Professor', 'B.M.S College of Engineering,\r\nBangalore ', 'Academic Council Nominee'),
(17, 2, 'Mrs.K.Sangeetha', 'Database Architect', 'Robert Bosch, Bangalore.\r\n', 'Industry Expert'),
(18, 2, 'Mr.Sandesh Nag Kotha, ', 'Associate Consultant,  ', 'TCS, Bangalore', 'Alumnus'),
(19, 2, 'Dr.S.Sumathi', 'Professor and Head', 'Department of ECE,Adhiyamaan College of Engineering', 'Inter Disciplinary Expert'),
(20, 2, 'Dr. D.Thilagavathy', 'Professor and Head', 'Department of CSE,Adhiyamaan College of Engineering', 'Inter Disciplinary Expert'),
(21, 2, 'Dr.M.Prabu', 'Professor', 'Department of CSE,Adhiyamaan College of Engineering', 'Inter Disciplinary Expert'),
(22, 2, 'Dr.P.Kavitha', 'Assistant Professor', 'Department of IT,Adhiyamaan College of Engineering', 'Internal Member'),
(23, 2, 'V.Siva Kumar', 'Assistant Professor', 'Department of IT,Adhiyamaan College of Engineering', 'Internal Member');
...
--
-- Dumping data for table `bit_dept`
--

INSERT INTO `bit_dept` (`id`, `ayear`, `intake1`, `aff1`, `aff_cer1`, `nba_cer1`, `intake2`, `aff2`, `aff_cer2`, `nba_cer2`, `intake3`, `aff3`, `aff_cer3`, `nba_cer3`) VALUES
(1, '2001-2002', 40, 'Anna University', '50910-affiation-02-03(40-60).pdf', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, '2002-2003', 60, 'Anna Univerisity', '78949-affiation-02-03(40-60).pdf', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, '2006-2007', 120, 'Anna University', '72451-affiation-02-03(40-60).pdf', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, '2018-2019', 60, 'Anna University', '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
-- Dumping data for table `bit_org`
--

INSERT INTO `bit_org` (`id`, `ayear`, `orgcategory1`, `orgtitle1`, `orgfun1`, `orgdays1`, `orgfrom1`, `orgto1`, `orgdate1`, `orgres1`, `orgpar1`, `orglevel1`, `orgcer1`, `orgkey`) VALUES
(1, '2017-2018', 'workshop', 'Web Application Development', 'Self', 2, '2017-08-21', '2017-08-22', '0000-00-00', 'Dr.LillyFlorance, Professor, D', 80, 'national', '9736-web.jpg', 1),
(2, '2018-2019', 'workshop', 'Mobile Application Development', 'SELF', 2, '2018-09-06', '2018-09-07', '0000-00-00', 'Arun David Johnson. R', 60, 'national', '41940-mobile-app-development.jpg', 1);
...
--
-- Dumping data for table `bit_stud`
--

INSERT INTO `bit_stud` (`id`, `ayear`, `year`, `sem`, `sec`, `level`, `batch`, `new_j`, `drop`, `d_discon`, `d_notreg`, `d_passed`, `d_others`, `g_boys`, `g_girls`, `g_others`, `c_bc`, `c_oc`, `c_bcm`, `c_mbc`, `c_sca`, `c_obc`, `c_sc`, `c_st`, `c_others`, `r_hindu`, `r_muslim`, `r_christian`, `r_others`, `stud`, `drop_file`, `stud_file`) VALUES
(0, '2015-2016', 'I', 1, 'A', 'ug', '2015-2019', 0, 0, 0, 0, 0, 0, 48, 29, 0, 40, 10, 1, 22, 0, NULL, 4, 0, NULL, NULL, NULL, NULL, NULL, 77, '0', 'BIT-2015-2019-I-1-A-NEW-2015-2019 IT 1st Sem.csv'),
(0, '2015-2016', 'I', 2, 'A', 'ug', '2015-2019', 0, 2, 1, 1, 0, 0, 46, 29, 0, 38, 10, 1, 22, 0, NULL, 4, 0, NULL, NULL, NULL, NULL, NULL, 75, '0', 'BIT-2015-2019-I-2-A-NEW-2015-2019 IT 2nd Sem.csv'),
(0, '2018-2019', 'I', 1, 'A', 'ug', '2018-2022', 0, 0, 0, 0, 0, 0, 36, 24, 0, 29, 6, 2, 16, 1, NULL, 6, 0, NULL, NULL, NULL, NULL, NULL, 60, '0', 'BIT-2018-2022-I-1-A-NEW-2018-2022-FIRST.csv'),
(0, '2018-2019', 'I', 2, 'A', 'ug', '2018-2022', 0, 1, 1, 0, 0, 0, 36, 23, 0, 29, 6, 2, 15, 1, NULL, 6, 0, NULL, NULL, NULL, NULL, NULL, 59, '0', 'BIT-2018-2022-I-2-A-NEW-2018-2022-II.csv');
...
(6, 'EIE', '2007-2008', 'BE', 'EIE', NULL, '', NULL, NULL, NULL, NULL, 6, 5),
(7, 'BIT', '2001-2002', 'B.Tech', 'Information Technology', NULL, '', NULL, NULL, NULL, NULL, 6, 2),
(8, 'ECE', '1987-1988', 'BE', 'ECE', NULL, '', NULL, NULL, NULL, NULL, NULL, NULL),
(9, 'MEC', '1991-1992', 'B.E', 'MECHANICAL ENGINEERING ', NULL, '', NULL, NULL, NULL, NULL, NULL, NULL);
...
--
-- Dumping data for table `ece_dept`
--

INSERT INTO `ece_dept` (`id`, `ayear`, `intake1`, `aff1`, `aff_cer1`, `nba_cer1`, `intake2`, `aff2`, `aff_cer2`, `nba_cer2`, `intake3`, `aff3`, `aff_cer3`, `nba_cer3`) VALUES
(1, '1988-1989', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, '1987-1988', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
-- Dumping data for table `ece_stud`
--

INSERT INTO `ece_stud` (`id`, `ayear`, `year`, `sem`, `sec`, `level`, `batch`, `new_j`, `drop`, `d_discon`, `d_notreg`, `d_passed`, `d_others`, `g_boys`, `g_girls`, `g_others`, `c_bc`, `c_oc`, `c_bcm`, `c_mbc`, `c_sca`, `c_obc`, `c_sc`, `c_st`, `c_others`, `r_hindu`, `r_muslim`, `r_christian`, `r_others`, `stud`, `drop_file`, `stud_file`) VALUES
(0, '2014-2015', 'I', 1, 'C', 'ug', '2014-2018', 0, 0, 0, 0, 0, 0, 25, 35, 0, 26, 10, 2, 19, 0, NULL, 3, 0, NULL, NULL, NULL, NULL, NULL, 60, '0', 'ECE-2014-2018-I-1-C-NEW-I ECE C.csv'),
(0, '2014-2015', 'I', 2, 'C', 'ug', '2014-2018', 0, 0, 0, 0, 0, 0, 25, 35, 0, 26, 10, 2, 19, 0, NULL, 3, 0, NULL, NULL, NULL, NULL, NULL, 60, '0', 'ECE-2014-2018-I-2-C-NEW-I ECE C.csv'),
(0, '2015-2016', 'II', 3, 'C', 'ug', '2014-2018', 0, 0, 0, 0, 0, 0, 25, 35, 0, 26, 10, 2, 19, 0, NULL, 3, 0, NULL, NULL, NULL, NULL, NULL, 60, '0', 'ECE-2014-2018-II-3-C-NEW-I ECE C.csv'),
(0, '2015-2016', 'II', 4, 'C', 'ug', '2014-2018', 0, 0, 0, 0, 0, 0, 25, 35, 0, 26, 10, 2, 19, 0, NULL, 3, 0, NULL, NULL, NULL, NULL, NULL, 60, '0', 'ECE-2014-2018-II-4-C-NEW-I ECE C.csv'),
(0, '2016-2017', 'III', 5, 'C', 'ug', '2014-2018', 0, 0, 0, 0, 0, 0, 25, 35, 0, 26, 10, 2, 19, 0, NULL, 3, 0, NULL, NULL, NULL, NULL, NULL, 60, '0', 'ECE-2014-2018-III-5-C-NEW-I ECE C.csv'),
(0, '2016-2017', 'III', 6, 'C', 'ug', '2014-2018', 0, 0, 0, 0, 0, 0, 25, 35, 0, 26, 10, 2, 19, 0, NULL, 3, 0, NULL, NULL, NULL, NULL, NULL, 60, '0', 'ECE-2014-2018-III-6-C-NEW-I ECE C.csv'),
(0, '2017-2018', 'IV', 7, 'C', 'ug', '2014-2018', 0, 0, 0, 0, 0, 0, 25, 35, 0, 26, 10, 2, 19, 0, NULL, 3, 0, NULL, NULL, NULL, NULL, NULL, 60, '0', 'ECE-2014-2018-IV-7-C-NEW-I ECE C.csv'),
(0, '2017-2018', 'IV', 8, 'C', 'ug', '2014-2018', 0, 0, 0, 0, 0, 0, 25, 35, 0, 26, 10, 2, 19, 0, NULL, 3, 0, NULL, NULL, NULL, NULL, NULL, 60, '0', 'ECE-2014-2018-IV-8-C-NEW-I ECE C.csv');
...
--
-- Dumping data for table `eie_dept`
--

INSERT INTO `eie_dept` (`id`, `ayear`, `intake1`, `aff1`, `aff_cer1`, `nba_cer1`, `intake2`, `aff2`, `aff_cer2`, `nba_cer2`, `intake3`, `aff3`, `aff_cer3`, `nba_cer3`) VALUES
(1, '2007-2008', 60, 'ANNA UNIVERSITY', '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, '2009-2010', 120, 'ANNA UNIVERSITY', '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, '2015-2016', 120, 'ANNA UNIVERSITY', '', '28092-nba-certificate.pdf', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, '2018-2019', 60, 'ANNA UNIVERSITY', '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(3, 3, '2008-2009', '2009-04-21', '62135-mca_bos_3.jpg');
...
(23, 2, 'Mr. P Ilavarasu', 'Lead Engineer', 'Fair Isacc,\r\nBangalore', 'Industry Representative'),
(24, 3, 'Prof. D Swamydoss', 'Professor', 'Professor & Head,\r\nDepartment of MCA,\r\nAdhiyamaan College of Engineering,\r\nHosur', 'Chairman'),
(25, 3, 'Prof. M Lilly Florence', 'Asst. Prof.', '\r\nDepartment of MCA,\r\nAdhiyamaan College of Engineering,\r\nHosur  ', 'Internal Member'),
(26, 3, 'Mr. S Saravanan', 'Lecturer', 'Department of MCA,\r\nAdhiyamaan College of Engineering,\r\nHosur    ', 'Internal Member'),
(27, 3, 'Mr. N Sakthivel', 'Lecturer', 'Department of MCA,\r\nAdhiyamaan College of Engineering,\r\nHosur    ', 'Internal Member'),
(28, 3, 'Ms. V Sathya', 'Lecturer', 'Department of MCA,\r\nAdhiyamaan College of Engineering,\r\nHosur    ', 'Internal Member'),
(29, 3, 'Mr. V Alanthuraiyan', 'Lecturer', 'Department of MCA,\r\nAdhiyamaan College of Engineering,\r\nHosur    ', 'Internal Member'),
(30, 3, 'Prof. Krishna Kumar', 'Dean', 'Department of MCA,\r\nSona College of Technology,\r\nSalem', 'University Nominee'),
(31, 3, 'Ms. G Vijayalakshmi', 'Software Engineer', 'Wipro GE,\r\nBangalore', 'Alumni Representative');
...
--
-- Dumping data for table `mec_dept`
--

INSERT INTO `mec_dept` (`id`, `ayear`, `intake1`, `aff1`, `aff_cer1`, `nba_cer1`, `intake2`, `aff2`, `aff_cer2`, `nba_cer2`, `intake3`, `aff3`, `aff_cer3`, `nba_cer3`) VALUES
(1, '1991-1992', 60, 'AICTE', '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
-- Dumping data for table `mec_stud`
--

INSERT INTO `mec_stud` (`id`, `ayear`, `year`, `sem`, `sec`, `level`, `batch`, `new_j`, `drop`, `d_discon`, `d_notreg`, `d_passed`, `d_others`, `g_boys`, `g_girls`, `g_others`, `c_bc`, `c_oc`, `c_bcm`, `c_mbc`, `c_sca`, `c_obc`, `c_sc`, `c_st`, `c_others`, `r_hindu`, `r_muslim`, `r_christian`, `r_others`, `stud`, `drop_file`, `stud_file`) VALUES
(0, '2014-2015', 'I', 1, 'B', 'ug', '2014-2018', 0, 0, 0, 0, 0, 0, 34, 0, 0, 22, 2, 1, 8, 0, NULL, 1, 0, NULL, NULL, NULL, NULL, NULL, 34, '0', 'MEC-2014-2018-I-1-B-NEW-2014-2015.csv'),
(0, '1991-1992', 'II', 1, 'B', 'ug', '2015-2016', 0, 0, 0, 0, 0, 0, 33, 0, 0, 21, 2, 1, 8, 0, NULL, 1, 0, NULL, NULL, NULL, NULL, NULL, 33, '0', 'MEC-2015-2016-II-1-B-NEW-2015-2016.csv'),
(0, '2014-2015', 'I', 2, 'B', 'ug', '2014-2018', 0, 0, 0, 0, 0, 0, 34, 0, 0, 22, 2, 1, 8, 0, NULL, 1, 0, NULL, NULL, NULL, NULL, NULL, 34, '0', 'MEC-2014-2018-I-2-B-NEW-2014-2015.csv'),
(0, '2015-2016', 'II', 3, 'B', 'ug', '2014-2018', 0, 0, 0, 0, 0, 0, 34, 0, 0, 22, 2, 1, 8, 0, NULL, 1, 0, NULL, NULL, NULL, NULL, NULL, 34, '0', 'MEC-2014-2018-II-3-B-NEW-2014-2015.csv'),
(0, '2015-2016', 'II', 4, 'B', 'ug', '2014-2018', 0, 1, 0, 1, 0, 0, 33, 0, 0, 21, 2, 1, 8, 0, NULL, 1, 0, NULL, NULL, NULL, NULL, NULL, 33, '0', 'MEC-2014-2018-II-4-B-NEW-2015-2016.csv'),
(0, '2016-2017', 'III', 5, 'B', 'ug', '2014-2018', 0, 0, 0, 0, 0, 0, 33, 0, 0, 21, 2, 1, 8, 0, NULL, 1, 0, NULL, NULL, NULL, NULL, NULL, 33, '0', 'MEC-2014-2018-III-5-B-NEW-2015-2016.csv'),
(0, '2016-2017', 'III', 6, 'B', 'ug', '2014-2018', 0, 1, 0, 1, 0, 0, 32, 0, 0, 20, 2, 1, 8, 0, NULL, 1, 0, NULL, NULL, NULL, NULL, NULL, 32, '0', 'MEC-2014-2018-III-6-B-NEW-2016-2017.csv'),
(0, '2017-2018', 'IV', 7, 'B', 'ug', '2014-2018', 0, 0, 0, 0, 0, 0, 32, 0, 0, 20, 2, 1, 8, 0, NULL, 1, 0, NULL, NULL, NULL, NULL, NULL, 32, '0', 'MEC-2014-2018-IV-7-B-NEW-2017-2018.csv'),
(0, '2017-2018', 'IV', 8, 'B', 'ug', '2014-2018', 0, 0, 0, 0, 0, 0, 32, 0, 0, 20, 2, 1, 8, 0, NULL, 1, 0, NULL, NULL, NULL, NULL, NULL, 32, '0', 'MEC-2014-2018-IV-8-B-NEW-2017-2018.csv');
...
--
-- Dumping data for table `vmc_org`
--

INSERT INTO `vmc_org` (`id`, `ayear`, `orgcategory1`, `orgtitle1`, `orgfun1`, `orgdays1`, `orgfrom1`, `orgto1`, `orgdate1`, `orgres1`, `orgpar1`, `orglevel1`, `orgcer1`, `orgkey`) VALUES
(1, '1975-1976', 'sdp', 'web development', 'csi', 1, '0000-00-00', '0000-00-00', '1975-10-12', 'Shiva', 20, 'district', '3886-76706-10th.pdf', 1),
(2, '1975-1976', 'sdp', 'web development', 'csi', 1, '0000-00-00', '0000-00-00', '1975-10-14', 'Shiva', 50, 'national', '45948-76706-10th.pdf', 1);
...
(4, '2018-2019', 'guest_l', 'web development', 'self', 1, '0000-00-00', '0000-00-00', '2019-01-12', 'Shiva', 50, 'national', '87661-250px-czech_passport_2006_mrz_data.jpg', 1),
(5, '2017-2018', 'conference', 'web development', 'csi', 1, '0000-00-00', '0000-00-00', '2017-12-12', 'Shiva', 50, 'national', '82193-250px-czech_passport_2006_mrz_data.jpg', 1),
(6, '2015-2016', 'guest_l', 'web development', 'csi', 1, '0000-00-00', '0000-00-00', '2015-12-12', 'Shiva', 50, 'national', '80979-250px-czech_passport_2006_mrz_data.jpg', 1),
(7, '2014-2015', 'workshop', 'IOT', 'csi', 1, '0000-00-00', '0000-00-00', '2014-12-12', 'Mohan', 12, 'national', '46586-250px-czech_passport_2006_mrz_data.jpg', 1);
...
(20, '2013-2014', 'I', 1, 'A', 'ug', '2013-2017', 0, 0, 0, 0, 0, 0, 10, 10, 0, 5, 5, 5, 5, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, 20, '0', 'vv-2013-2017-I-1-A-NEW-ss.csv'),
(21, '2006-2007', 'I', 1, 'A', 'ug', '2006-2010', 0, 0, 0, 0, 0, 0, 10, 10, 0, 5, 5, 5, 5, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, 20, '0', 'vv-2006-2010-I-1-A-NEW-sample_file (14).csv'),
(22, '2006-2007', 'I', 2, 'A', 'ug', '2006-2010', 2, 4, 1, 1, 1, 1, 9, 9, 0, 5, 5, 5, 3, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, 18, 'vv-2006-2010-I-2-A-DROP-', 'vv-2006-2010-I-2-A-NEW-sample_file (15).csv'),
(23, '2006-2007', 'I', 1, 'A', 'ug', '2006-2010', 22, 2, 1, 1, 0, 0, 10, 10, 0, 5, 5, 5, 5, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, 20, 'vv-2006-2010-I-1-A-DROP-', 'vv-2006-2010-I-1-A-NEW-sample_file (15).csv');
