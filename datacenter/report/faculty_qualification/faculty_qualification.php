...
<body>
  ...
  <form class="modal-content animate" action="faculty_qualification1.php" method="post" id = "form" onsubmit="return(validate());">
...
<select name='qual'>
	...
	<option value="pursuing"> Ph.D Pursuing </option>
