...
<body>
  ...
  <form class="modal-content animate" action="faculty_member1.php" method="post" id = "form" onsubmit="return(validate());">

    <div class="container">
      
	
	<input type="radio" name="cat" value="dept" onClick="hideAB()"> All <br>
	<input type="radio" name="cat" value="in"  onClick="hideB()"> Indvidual <br><br>
	<div style="display:none" id="AB">
	<div style="display:none" id="A">
   	 <input type="hidden" id="dept" onFocus="this.value=''" value="<?php echo $_SESSION['deptid'] ?>" name="dept">
...
<div style="display:none" id="B">
 ...
 <label for="uname"><b>Profesional Society</b></label>
  <input type="text" id="to" onFocus="this.value=''" placeholder="Profesional Society Name" name="qual"  required>
<!--<select name='qual'>
