 ...
 <form role="form" action="#" method="post" enctype="multipart/form-data" onsubmit="return(fileValidate());" >
  ...
  // $sid=$_POST["sid"];
   $deptid=$_SESSION['deptid'];	
	...
	$sql2="SELECT * FROM `$aaa2` WHERE sid = '$sid'";
	...
	$sql3="SELECT * FROM `$aaa3` WHERE sid = '$sid'";
	...
	$sql4="SELECT * FROM `$aaa4` WHERE sid = '$sid'";
	...
	$sql5="SELECT * FROM `$aaa5` WHERE sid = '$sid'";
	...
	$sql11="SELECT * FROM `$aaa11` WHERE sid = '$sid'";
