...
<?php
$name_sci=$_SESSION['name_sci'];
$sql2="SELECT * FROM soci_org WHERE name_sci='$name_sci'";
...
echo'<br>';
			...
			echo'</TR>';
			$sql1="SELECT * FROM soci_org WHERE name_sci='$name_sci' ORDER BY ayear DESC";
	...
	if ($result->num_rows > 0) 
	{
		...
		while($row = $result->fetch_assoc()) 
		{
			...
			<TD>
<?php $a=$row["orgcer1"]; ?>			
	<a href="../gallery/prof_soci/<?php echo $a; ?>" target="_blank">View</a>
</TD>			
...
?>
 <form class="modal-content animate" action="soci_org.php" method="post">
...
?>
  ...
  <form action="soci_org.php" method="post" enctype="multipart/form-data" id = "form" onsubmit="return(validate());">
    <div class="row">
      <div class="col-25">
  ...
  <option value="symposium">Symposium</option>
	 ...
	 <div class="row">
      ...
      <div class="col-75">
        ...
        <input type="hidden" id="name_sci" name="name_sci"  value="<?php echo $name_sci;?>" required>
      </div>
    </div>
...
if(isset($_POST["submit"])){
 ...
 $file = rand(1000,100000)."-".$_FILES['file']['name'];
	...
	$final_file=str_replace(' ','-',$new_file_name);
	  ...
	  {
		$sql6 = "INSERT into soci_org (ayear,orgcategory1,orgtitle1,orgfun1,orgdays1,orgfrom1,orgto1,orgdate1,orgres1,orgpar1,orglevel1,orgcer1,name_sci,orgkey) VALUES ('$ayear','$orgcategory','$orgtitle','$orgfun','$orgdays','$orgfrom','$orgto','$orgdate','$orgres','$orgpar','$orglevel','$final_file','$name_sci',1)";	
