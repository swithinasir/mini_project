...
$abc=$deptid."_stud";
		...
		$sql2="SELECT * FROM `$abc` WHERE level='ug'  ORDER BY ayear DESC";
...
?>		
	...
	if ($result2->num_rows > 0) 
	{
		while($row1 = $result2->fetch_assoc()) 
		{
			...
			<form action="stud_ug.php" method="post" >
	...
	$sql5 = "DELETE FROM `$abc` WHERE id = '$id'";
						if(mysqli_query($con,$sql5))
						{
							...
							echo '<script type="text/javascript">window.location.href = "stud_ug.php";</script>';
						}
}
	?>