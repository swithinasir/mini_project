...
function validate()
{
	var days = document.getElementById("attdays").value;
	if(days>1)
	{
	var valid = true;
...
<ul> 
  <li><a class="active"  href="att_fac.php" target= "frame1" >PROGRAMME ATTENDED</a></li>  
...
echo'<br>';
	...
	<a href="../../gallery/atten/<?php echo $aaa; ?>/<?php echo $a; ?>" target="_blank">View</a>
<?php
				echo'</center></TD>';
...
?>
 <form class="modal-content animate" action="att_fac.php" method="post">
...
<?php
  ...
  <form class="modal-content animate" action="att_fac.php" method="post">
    ...
    <div class="container1">
      <label for="uname"><b>No.Of.Days Programme Attended</b></label>
...
$days =$_POST['days'];
?>
  <form action="att_fac.php" method="post" enctype="multipart/form-data" id = "form" onsubmit="return(validate());">
    <div class="row">
      <div class="col-25">
...
?> 
  ...
  <option value="summerorwinter">Summer/Winter School</option>
	 ...
	 <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="atttitle" name="atttitle" required>
      </div>
    </div>
...
<?php
    ...
    <div class="row">
      <div class="col-25">
        <label for="lname">Organized by</label>
      </div>
      <div class="col-75">
        <input type="text" id="attorg" name="attorg" required>
      </div>
    </div>
	...
	<div class="row">
      ...
      <div class="col-75">
        <input type="text" id="attplace" name="attplace" required>
      </div>
    </div>
	<div class="row">
      <div class="col-25">
  ...
  <option value="national">National</option>
   <option value="international">International</option>
    ...
    <div class="row">
      <div class="col-25">
        <label for="subject">Upload Certificate(Only PDF )</label>
...
if(isset($_POST["submit"])){
 ...
 $ayear=$_POST["ayear"];
 $attcategory=$_POST["attcategory"];
 $atttitle =$_POST["atttitle"];
 $attdays =$_POST["attdays"];
 $attorg=$_POST["attorg"];
 $attplace =$_POST["attplace"];
 $attlevel =$_POST["attlevel"];
 ...
 $file = rand(1000,100000)."-".$_FILES['file']['name'];
	...
	$final_file=str_replace(' ','-',$new_file_name);
	  ...
	  {
		$sql6 = "INSERT into `$aaa` (sid,ayear,attcategory1,atttitle1,attdays1,attfrom1,attto1,attdate1,attorg1,attplace1,attlevel1,attcer1,attkey) VALUES ('$sid','$ayear','$attcategory','$atttitle','$attdays','$attfrom','$attto','$attdate','$attorg','$attplace','$attlevel','$final_file',1)";			if(mysqli_query($con,$sql6))
		{
			
			echo '<script language="javascript">alert("Program Attended Details Inserted Successfully");</script>';
