...
$sql1="SELECT sid, uname, supid, COUNT(supid) FROM `$aaa` WHERE sid = '$sid' GROUP BY supid HAVING COUNT(supid) > 1";
...
$all_suid=array();
	...
	{		
		...
		{		 
			...
			echo '<div class="col-25"><b>Number of Scholars : </b>'.$row["COUNT(supid)"].'</div>';
			...
			while($row2 = $result2->fetch_assoc()) 
			{
				...
				{	
				?>
				<form action="ures.php" method="post" enctype="multipart/form-data" onsubmit="return(validate());">
			...
			if(isset($_POST["addsch"]))
			{
				...
				?>
					<form action="res_gui_fac.php" method="post">
						...
						echo'<TD><INPUT type="text" name="j_sup'.$i.'" Placeholder="Joint Supervisor"/></TD>';
						echo'</TR>';
						echo'</table>';	
						?>
						<!--<div class="row">
	...
	{	
		if(isset($_POST["add"]))
		{
			...
			<form action="res_gui_fac.php" method="post">    
				<div class="row">
					<div class="col-25">
						<label for="fname"  class="required">Name of the University</label>
					</div>  
					<div class="col-75">
				...
				<div class="row">
					<div class="col-25">
						<label for="fname"  class="required">Supervisor ID</label>
					</div>
					<div class="col-75">
				...
				<div class="row">
					<div class="col-25">
						<label for="fname"  class="required">No.of.Scholars</label>
					</div>
					<div class="col-25">
...
$reg="reg".$i;
 ...
 $tit =$_POST["tit".$i];
 $j_sup =$_POST["j_sup".$i];
		$sql6 = "INSERT into `$aaa` (sid,uname,supid,reg,name,year,spec,tit,j_sup) VALUES ('$sid','$uname','$supid','$reg','$name','$year','$spec','$tit','$j_sup')";	
		...
		{
			echo "Error1: " . $sql6 . "<br>" . $conn->error;
		}
}
 ...
 $j_sup =$_POST["j_sup"];
				...
				$sql4 = "INSERT into `$aaa` (sid,uname,supid,reg,name,year,spec,tit,j_sup) VALUES ('$sid','$uname','$supid','$reg','$name','$year','$spec','$tit','$j_sup')";	
