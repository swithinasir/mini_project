...
$all_suid=array();
			...
			if(isset($_POST["addsch"]))
			{
				...
				?>
					<form action="res_gui_fac.php" method="post">
						...
						echo'<TD><INPUT type="text" name="j_sup" Placeholder="Joint Supervisor"/></TD>';
						echo'</TR>';
						echo'</table>';	
						?>
						<!--<div class="row">
	...
	{	
		if(isset($_POST["add"]))
		{
			...
			?>
			<form action="res_gui_fac.php" method="post" enctype="multipart/form-data" onsubmit="return(validate());">    
				<div class="row">
					<div class="col-25">
...
$reg="reg".$i;
 ...
 $tit =$_POST["tit".$i];
 $j_sup =$_POST["j_sup".$i];
		$sql6 = "INSERT into `$aaa` (sid,uname,supid,reg,name,year,spec,tit,j_sup,cyear) VALUES ('$sid','$uname','$supid','$reg','$name','$year','$spec','$tit','$j_sup','ongoing')";	
 ...
 $j_sup =$_POST["j_sup"];
				...
				$sql4 = "INSERT into `$aaa` (sid,uname,supid,reg,name,year,spec,tit,j_sup,cyear) VALUES ('$sid','$uname','$supid','$reg','$name','$year','$spec','$tit','$j_sup','ongoing')";	
