...
$reg="reg".$i;
 ...
 $spec=$_POST["spec".$i];
 $tit =$_POST["tit".$i];
		$sql6 = "INSERT into `$aaa` (sid,uname,supid,reg,name,year,spec,tit) VALUES ('$sid','$uname','$supid','$reg','$name','$year','$spec','$tit')";	
 ...
 $tit =$_POST["tit"];
				...
				$sql4 = "INSERT into `$aaa` (sid,uname,supid,reg,name,year,spec,tit) VALUES ('$sid','$uname','$supid','$reg','$name','$year','$spec','$tit')";	
