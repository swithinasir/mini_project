...
if(isset($_POST["update"])){
 $id=$_POST["id"];
  ?>
	<form class="modal-content animate" action="facility_dept1.php"  method="post" enctype="multipart/form-data">
			<br>
		...
		<div class="col-25">
			<input type="text" id="class" name="class" value="<?php echo $_POST["class"] ?>" >
		</div>
	</div>	
	<div class="row">
	<div class="col-25"></div>
		...
		<div class="col-25">
			<input type="text" id="lab" name="lab" value="<?php echo $_POST["lab"] ?>" >
		</div>
	...
	<div class="col-25"></div>
		<div class="col-25">				
					<button type="submit" name="update1" style="width:auto;">UPDATE</button>
		</div>
...
if(isset($_POST["update2"])){
	...
	$row3 = $result3->fetch_assoc();?>
			<form class="modal-content animate" action="facility_dept1.php"  method="post">
				<br>
			<div class="row">
					<INPUT type="hidden" name="id" value="<?php echo $id; ?>" />
					<div class="col-25"></div>
					<div class="col-25">
						<label for="fname">Name of the Equipment </label>
					</div>
					<div class="col-25">
			...
			<div class="row">
					...
					<div class="col-25">
						<INPUT type="text" name="model" value="<?php echo $row3["model"] ?>"  />
					</div>
			</div>
			<div class="row">
					<div class="col-25"></div>
					...
					<div class="col-25">
						<INPUT type="text" name="quantity" value="<?php echo $row3["quantity"] ?>"  /><br>
					</div>
			</div>
			<div class="row">
					<div class="col-25"></div>
					...
					<div class="col-25">
						<INPUT type="text" name="year" value="<?php echo $row3["year"] ?>"  /><br>
					</div>
			</div>
			<div class="row">
					<div class="col-25"></div>
					...
					<div class="col-25">
						<INPUT type="text" name="price" value="<?php echo $row3["price"] ?>"  /><br>
					</div>
			</div>
			<div class="row">
					<div class="col-25"></div>
					<div class="col-25">
						<button type="submit" name="update3" style="width:auto;">Update</button>
					</div>
			</div>
...
if(isset($_POST["update3"])){
	...
	$deptid=$_SESSION['deptid'];
	$aaa=$deptid."_faci";
	$sql5 = "UPDATE `$aaa` SET `name`= '$name' ,`model`= '$model' , `quantity`= '$quantity' ,`year`= '$year' , `price`= '$price'   WHERE id = '$id'";
...
if(isset($_POST["upload2"])){
	...
	$move=move_uploaded_file($file_loc,$folder.$final_file);
		...
		$sql1 = "UPDATE `$aaa` SET `invoice`= '$final_file'  WHERE id = '$id'";
