...
if(!isset($_POST["update"])){
  ...
  $f=$_POST["f"];
  ?>
	<form class="modal-content animate" action="about_dept1.php"  method="post" enctype="multipart/form-data">
			<br>
			<div class="row">
				<center>
...
if(isset($_POST["update"])){
	...
	$row3 = $result3->fetch_assoc();?>
			<form class="modal-content animate" action="about_dept1.php"  method="post">
				<br>
			<div class="row">
					<INPUT type="hidden" name="id" value="<?php echo $id; ?>" />
			...
			<div class="row">
					...
					<div class="col-25">
						<INPUT type="text" name="aff1" value="<?php echo $row3["aff1"] ?>"  /><br>
					</div>
			</div>
			<div class="row">
					<div class="col-25"></div>
...
if(isset($_POST["update2"])){
	...
	$deptid=$_SESSION['deptid'];
	$aaa=$deptid."_dept";
	$sql5 = "UPDATE `$aaa` SET `ayear`= '$ayear' ,`intake1`= '$intake1' , `aff1`= '$aff1'   WHERE id = '$id'";
...
if(isset($_POST["upload2"])){
	...
	if($f==1)
	{
		$sql1 = "UPDATE `$aaa` SET `aff_cer1`= '$final_file'  WHERE id = '$id'";
	}
	else
	{
		$sql1 = "UPDATE `$aaa` SET `nba_cer1`= '$final_file'  WHERE id = '$id'";
	}
