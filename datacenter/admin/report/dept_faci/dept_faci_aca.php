...
<ul>
  ...
  <li><a class="active" href="#" target= "frame1">Academic Year</a></li>
   <li><a  href="dept_faci_type.php" target= "frame1">Type of Facility</a></li>   
</ul>
</nav>
<br>
  <form class="modal-content animate" action="dept_faci1.php" method="post">
    ...
    <div class="container">
      ...
      <INPUT type="hidden" name="type" value="aca" />
