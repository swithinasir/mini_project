...
<ul>
  ...
  <li><a href="dept_faci_aca.php" target= "frame1">Academic Year</a></li>
   <li><a class="active"  href="#" target= "frame1">Type of Facility</a></li>    
</ul>
</nav>
<br>
  <form class="modal-content animate" action="dept_faci1.php" method="post">

    <div class="container">
	<INPUT type="hidden" name="type" value="event" />
      <input type="hidden" id="from"  value="1987" name="from" required> 
	  <?php
				$end=date("Y");
				if(date("m")<6)
				{
				...
				?>
      <input type="hidden" id="to"  value="<?php echo $end; ?>" name="to" required>
...
<br>
 <label for="uname"><b>Type of Facility</b></label>
<select name='qual'>
