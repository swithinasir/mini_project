...
<body>
  ...
  <form class="modal-content animate" action="faculty_rese_guide1.php" method="post" id = "form">

    <div class="container">
	<input hidden name="from" value="1987">
	<?php
				$end=date("Y");
				if(date("m")<6)
				{
	...
	<input hidden name="to" value="<?php echo $end; ?>">
