...
header("Content-Disposition: attachment;Filename=faculty_guest_lecture.doc");    
echo "<html>";
...
else
{
	...
	echo '<script type="text/javascript">window.location.href = "faculty_guest_lecture.php";</script>';
}
?>	