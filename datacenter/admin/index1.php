      ...
      <!-- second menu bar -->
        ...
        <!-- submenu elements for #b-menu-2 -->
		  ...
		  <ul class="nav navbar-nav">		  
            <li class="active"><a href="#"><img width="35px" height="25px" src="../images/admin.png"></a></li>
			<li><a href="department/dept_frame.php">DEPARTMENT</a></li>
			<li><a href="report/report_frame.php">REPORT</a></li> 
			<li><a href="ins/ins_frame.php">INSTITUTE INFO</a></li> 
			<li><a href="database.php">EXPORT</a></li> 
